    ...
    <div className="my-16 theme-container mx-auto">
      ...
      <div className="w-full ">
        <p className="text-paragraph  sm:text-[20px] mt-[22px] mb-[50px]">
          PINTAR (Portal Informasi Kompetensi Aparatur) adalah dashboard
          monitoring yang menampilkan data pelaksanaan pelatihan ASN secara
          real-time. Portal ini membantu pimpinan memantau capaian JP (Jam
          Pelajaran), IPASN (Indeks Profesionalitas ASN), serta statistik
          kegiatan pelatihan di setiap unit kerja.
        </p>
      ...
      <div>
        <ServiceOne data={data} />

        <p className="text-paragraph  sm:text-[20px]  mb-[50px]">
          Melalui PINTAR, ASN dapat memantau perkembangan jam pelatihan dan
          capaian kompetensi secara mandiri, sekaligus membantu pimpinan melihat
          kebutuhan pengembangan SDM di setiap unit kerja. Portal ini mendukung
          penerapan sistem merit dan pelaksanaan reformasi birokrasi yang
          berbasis data, serta meningkatkan transparansi dalam pengelolaan
          pelatihan di lingkungan instansi. Dengan demikian, PINTAR menjadi
          salah satu alat pendukung terwujudnya ASN yang profesional, kompeten,
          dan siap menghadapi tantangan kerja ke depan.
        </p>
      </div>
...
const data = [
  {
    title: "Dashboard jam pelatihan (JP) ASN",
    description:
  ...
  {
    title: "Pendaftaran dan seleksi peserta online.",
    description:
      "Defined by digital dynamism, our digital marketing agency emerges as a beacon of innovation",
    icon: (
      <svg
  ...
  {
    title: "Grafik capaian IPASN per unit kerja.",
    description:
      "Defined by digital dynamism, our digital marketing agency emerges as a beacon of innovation",
    icon: (
      <svg
  ...
  {
    title: "Statistik jumlah pelatihan, peserta, dan sertifikat.",
    description:
      "Defined by digital dynamism, our digital marketing agency emerges as a beacon of innovation",
    icon: (
      <svg
  ...
  {
    title: "Laporan perkembangan kompetensi pegawai.",
    description:
      "Defined by digital dynamism, our digital marketing agency emerges as a beacon of innovation",
    icon: (
      <svg
  ...
  {
    title:
      "Rekap data per unit kerja untuk mendukung evaluasi dan pengambilan kebijakan.",
    description:
      "Defined by digital dynamism, our digital marketing agency emerges as a beacon of innovation",
    icon: (
      <svg
