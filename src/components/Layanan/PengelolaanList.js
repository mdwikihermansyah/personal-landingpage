...
export default function PengelolaanList() {
  return (
    <div className="my-16 theme-container mx-auto">
      {/* <!-- single blog start --> */}
      <div className="w-full ">
        <p className="text-paragraph  sm:text-[20px] mt-[22px] mb-[50px]">
          SIMDIKLAT (Sistem Informasi Pendidikan dan Pelatihan) adalah platform
          digital untuk mengelola seluruh proses pelatihan ASN, mulai dari
          perencanaan, pendaftaran, penjadwalan, pelaksanaan, hingga penerbitan
          sertifikat pelatihan secara transparan dan terdokumentasi.
        </p>
      ...
      <div>
        ...
        <p className="text-paragraph  sm:text-[20px]  mb-[50px]">
          Dengan adanya SIMDIKLAT, ASN dapat lebih mudah mengakses berbagai
          program pelatihan yang relevan dengan tugas dan jabatannya, mengikuti
          proses pendaftaran dan seleksi secara transparan, serta memperoleh
          sertifikat resmi dengan cepat dan terdokumentasi dengan baik. Selain
          itu, SIMDIKLAT membantu ASN membangun rekam jejak kompetensi yang
          akurat sebagai bukti kualifikasi profesional, sehingga mendukung
          peningkatan kinerja dan pengembangan karier di masa depan.
        </p>
      </div>
...
const data = [
  {
    title: "Modul perencanaan dan jadwal pelatihan.",
    description:
  ...
  {
    title: "Presensi, penilaian, dan ujian peserta.",
    description:
      "Defined by digital dynamism, our digital marketing agency emerges as a beacon of innovation",
    icon: (
      <svg
  ...
  {
    title: "Penerbitan sertifikat elektronik.",
    description:
      "Defined by digital dynamism, our digital marketing agency emerges as a beacon of innovation",
    icon: (
      <svg
  ...
  {
    title: "Rekam jejak riwayat pelatihan pegawai.",
    description:
      "Defined by digital dynamism, our digital marketing agency emerges as a beacon of innovation",
    icon: (
      <svg
  ...
  {
    title: "Laporan kegiatan untuk pimpinan.",
    description:
      "Defined by digital dynamism, our digital marketing agency emerges as a beacon of innovation",
    icon: (
      <svg
