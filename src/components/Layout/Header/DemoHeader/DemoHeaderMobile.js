...
import { HEADER_MOBILE_LINKS } from "../../../../data/header";
        ...
        >
          <div className="flex flex-col pt-5 pl-5 gap-28">
            <ul className="flex flex-col gap-5 text-base font-medium leading-5 text-paragraph font-inter">
              {HEADER_MOBILE_LINKS.map((menuItem, index) => (
                <li key={index} className="group">
                  {menuItem.subMenu ? (
                    <>
                      ...
                      <ul
                        className={`overflow-hidden transition-all font-medium duration-300 pl-5 pt-4 ${
                    ...
                    <a
                      className="relative home-two-nav-item"
                      href={menuItem.href}
                    >
                      {menuItem.title}
                    </a>
          ...
          <div className="flex flex-col gap-5 pl-5 mt-5">
            ...
            >
              <div className="home-two-btn-bg py-1.5 px-3 group bg-blue-seo border-blue-seo w-fit rounded">
                <span className="relative z-10 text-sm font-semibold text-white transition-all duration-300 group-hover:text-blue-seo font-inter">
                  Hubungi kami
                </span>
                <svg
            ...
            >
              ...
              <span className="text-sm font-medium leading-5 tracking-tight text-main-black">
                {CONTACT_INFO.phone}
              </span>
            </a>
          </div>
